  ...
  <el-card>
    <el-tabs tab-position="left">
      <el-tab-pane label="通知栏">
        <el-row>
          <span style="margin-right: 10px">当前通知:</span>
          <span>{{ noticeText }}</span>
        </el-row>
        <el-row>
          <span style="margin-right: 10px;line-height: 30px">修改通知:</span>
          <el-input style="width: 300px;margin-right: 10px" v-model="input"
                    placeholder="填写通知内容"></el-input>
          <el-button type="primary" plain @click="commitNotice">提交</el-button>
        </el-row>
      </el-tab-pane>
        ...
        >
          ...
          <template #tip>
            <div style="padding: 5px">
              <el-tag type="danger" size="small">图片大小必须小于2MB!</el-tag>
            </div>
          </template>
        </el-upload>
      </el-tab-pane>
